import sys
import pygame
from Alien_Takeover.bullet import Bullet
from Alien_Takeover.alien import Alien
...
def check_high_score(stats, sb):
    ...
    if stats.score > stats.high_score:
        ...
        lst = stats.high_score
        pickle.dump(lst, open('HIGHSCORE.txt', 'wb'))
...
def check_play_buttons(ai_settings, screen, stats, sb, play_button, ship,
...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets,
    ...
    stats.high_score = pickle.load(open('HIGHSCORE.txt', 'rb'))
